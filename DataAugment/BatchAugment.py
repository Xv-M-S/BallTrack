        ...
        for img_file in os.listdir(image_split_dir):
            ...
            for _ in range(times):
                for label in labels:
                    ...
                    aug_img_path = os.path.join(output_image_split_dir, aug_img_name)
                    output_label_name = f"{Path(aug_img_name).stem}.txt"
                    output_label_path = os.path.join(output_label_split_dir, output_label_name)
                    # print(aug_img_path)
...
if __name__ == '__main__':
    data_dir = '/data01/migu/soccer-track/Yolov8_Formatted_DataSets/百度飞桨/final_dataset'
    output_dir = '/data01/migu/soccer-track/Yolov8_Formatted_DataSets_Augmented/百度飞桨/final_dataset'
